...
function UsuariosPage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setModalError(getApiErrorMessage(err, 'No se pudo guardar el usuario'));
    } finally {
      setSaving(false);
    }
  }
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <form className="form-grid" onSubmit={handleSubmit}>
              ...
              <label>
                Estado
                <select name="activo" value={form.activo ? 'true' : 'false'} onChange={(e) => setForm(prev => ({ ...prev, activo: e.target.value === 'true' }))}>
